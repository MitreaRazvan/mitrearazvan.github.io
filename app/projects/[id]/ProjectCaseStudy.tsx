...
<section className="max-w-6xl mx-auto px-6 mb-32">
  ...
  <p className="text-lg text-gray-700 dark:text-gray-300 mb-8 leading-relaxed">
    Explore the redesigned Generali Insurance app through this interactive prototype. Experience the streamlined onboarding, simplified dashboard, and intuitive policy management.
  </p>
  <div className="rounded-2xl overflow-hidden border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-900 p-4">
    <div className="w-full aspect-video flex items-center justify-center">
      <iframe 
        ...
        width="100%" 
        height="700" 
        src="https://embed.figma.com/proto/eyZPgrs44Ef5qlPsRcFnKC/Generali-Insurance-Updated?page-id=15%3A6&node-id=61-5926&viewport=574%2C584%2C0.26&scaling=scale-down&content-scaling=responsive&starting-point-node-id=61%3A5708&embed-host=share" 
        allowFullScreen
      ></iframe>
    </div>
  </div>
